...
const Rightbar = () => {
  ...
  if (!selectedUser) {
    return (
      <div className="w-80 h-screen border-l border-slate-200 bg-white hidden lg:flex items-center justify-center">
  ...
  return (
    <div className="w-80 h-screen border-l border-slate-200 bg-white hidden lg:flex flex-col overflow-y-auto">
      {/* User Profile Info */}
